...
const LS = {
  userData: 'wisebite_userData',
  meals: 'wisebite_meals',
  weights: 'wisebite_weights',
  insight: 'wisebite_insight',
  theme: 'wisebite_theme',
  units: 'wisebite_units',
  toasts: 'wisebite_toasts',
};
